...
| | |
|---|---|
| **Files to edit** | `PointGroup3heads.py` (line 11 + 3 call sites), `FORpartseg_3heads.yaml` (1 new key) |
...
| **Main trap** | the `class: minkowski.Minkowski_Model` yaml key is inert; the import on line 11 is the real switch |
| **Rollback** | revert line 11, or `export SPARSE_BACKEND=minkowski` |
